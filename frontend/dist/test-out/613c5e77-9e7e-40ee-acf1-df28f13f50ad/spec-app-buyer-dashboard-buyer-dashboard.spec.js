...
var init_buyer_dashboard = __esm({
  ...
  <div class="collapse navbar-collapse" [ngClass]="{ 'show': isMenuOpen }" id="adminNavbar">
    <ul class="navbar-nav mx-auto">
      ...
      <li class="nav-item mx-2">
        <a class="nav-link text-light" routerLink="/admin/book-management" (click)="viewcart()">View Cart</a>
      </li>
      <!-- <li class="nav-item mx-2">
        <a class="nav-link text-light" routerLink="/admin/donations" routerLinkActive="active">Place Order</a>
      </li> -->
      <!-- <li class="nav-item mx-2">
        <a class="nav-link text-light" routerLink="/admin/book-requests" routerLinkActive="active">Track Order</a>
      </li> -->
      <!-- <li class="nav-item mx-2">
        <a class="nav-link text-light" routerLink="/admin/book-requests" routerLinkActive="active">Bookmark</a>
      </li> -->
      <li class="nav-item mx-2">
