...
var require_admin_dashboard_spec = __commonJS({
  "src/app/admin-dashboard/admin-dashboard.spec.ts"(exports) {
    ...
    fdescribe("AdminDashboard", () => {
      ...
      it("should remove tokens and navigate on logout with Swal", () => __async(null, null, function* () {
        spyOn(localStorage, "removeItem");
        const routerSpy = spyOn(component["router"], "navigate");
        spyOn(import_sweetalert22.default, "fire").and.returnValue(Promise.resolve({}));
        yield component.onLogout();
        expect(import_sweetalert22.default.fire).toHaveBeenCalled();
